        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <div>
              ...
              <div className="space-y-3">
                <a
                  href="https://github.com/i-am-Els"
                  target="_blank"
                ...
                <a
                  href="https://www.linkedin.com/in/eniola-olawale-669019192/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center space-x-3 text-gray-300 hover:text-primary transition-colors"
                >
                ...
                <a
                  href="https://www.artstation.com/eniola-els"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center space-x-3 text-gray-300 hover:text-primary transition-colors"
                >
                ...
                <a
                  href="https://x.com/OlawaleEniolaE"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center space-x-3 text-gray-300 hover:text-primary transition-colors"
                >
